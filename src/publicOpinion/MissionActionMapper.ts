...
const MISSION_TRIGGER_MAP: Record<DirectionType, MissionTrigger[]> = {
  ...
  target_player: [
    { eventType: 'nominated_target',  requiresRelatedTarget: true,  weight: publicOpinionConfig.missionDirectProgressWeight },
  ...
  protect_player: [
    { eventType: 'saved_from_block',  requiresRelatedTarget: true,  weight: publicOpinionConfig.missionDirectProgressWeight },
    { eventType: 'pov_win',           requiresRelatedTarget: false, weight: publicOpinionConfig.missionIndirectProgressWeight },
  ...
  expose_player: [
    { eventType: 'spread_rumor',      requiresRelatedTarget: true,  weight: publicOpinionConfig.missionDirectProgressWeight },
    { eventType: 'confronted_player', requiresRelatedTarget: true,  weight: publicOpinionConfig.missionDirectProgressWeight },
    { eventType: 'negative_social',   requiresRelatedTarget: true,  weight: publicOpinionConfig.missionIndirectProgressWeight },
    { eventType: 'betrayal',          requiresRelatedTarget: true,  weight: publicOpinionConfig.missionIndirectProgressWeight },
  ],
  ...
  // ── Make a bold move ────────────────────────────────────────────────────
  make_bold_move: [
    { eventType: 'bold_move',         requiresRelatedTarget: false, weight: publicOpinionConfig.missionDirectProgressWeight },
    { eventType: 'confronted_player', requiresRelatedTarget: false, weight: publicOpinionConfig.missionIndirectProgressWeight },
    { eventType: 'hoh_win',           requiresRelatedTarget: false, weight: publicOpinionConfig.missionIndirectProgressWeight },
    { eventType: 'nominated_target',  requiresRelatedTarget: false, weight: publicOpinionConfig.missionIndirectProgressWeight },
    { eventType: 'chaos_action',      requiresRelatedTarget: false, weight: publicOpinionConfig.missionIndirectProgressWeight },
  ],
  ...
  // ── Show loyalty ────────────────────────────────────────────────────────
  show_loyalty: [
    { eventType: 'showed_loyalty',    requiresRelatedTarget: false, weight: publicOpinionConfig.missionDirectProgressWeight },
    { eventType: 'positive_social',   requiresRelatedTarget: true,  weight: publicOpinionConfig.missionIndirectProgressWeight },
    { eventType: 'saved_from_block',  requiresRelatedTarget: false, weight: publicOpinionConfig.missionIndirectProgressWeight },
    { eventType: 'voted_to_evict',    requiresRelatedTarget: false, weight: publicOpinionConfig.missionIndirectProgressWeight },
  ],
  ...
  start_drama: [
    { eventType: 'chaos_action',      requiresRelatedTarget: false, weight: publicOpinionConfig.missionDirectProgressWeight },
    { eventType: 'confronted_player', requiresRelatedTarget: false, weight: publicOpinionConfig.missionDirectProgressWeight },
    { eventType: 'spread_rumor',      requiresRelatedTarget: false, weight: publicOpinionConfig.missionIndirectProgressWeight },
    { eventType: 'negative_social',   requiresRelatedTarget: false, weight: publicOpinionConfig.missionIndirectProgressWeight },
    { eventType: 'betrayal',          requiresRelatedTarget: false, weight: publicOpinionConfig.missionIndirectProgressWeight },
  ],
  ...
  create_chaos: [
    ...
    { eventType: 'spread_rumor',      requiresRelatedTarget: false, weight: publicOpinionConfig.missionIndirectProgressWeight },
    { eventType: 'betrayal',          requiresRelatedTarget: false, weight: publicOpinionConfig.missionIndirectProgressWeight },
    { eventType: 'bold_move',         requiresRelatedTarget: false, weight: publicOpinionConfig.missionIndirectProgressWeight },
  ],
};
