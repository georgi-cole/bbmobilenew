    ...
    <main className="big-spender__table">
      <section className="big-spender__board-shell">
        <div className="big-spender__board-heading">
          <div>
            <span className="big-spender__metric-label">{wallIndex === 1 ? 'Fresh wallet wall' : 'Wallet wall'}</span>
            <strong>
              {secondChancePending
        ...
        {latestReveal && (
          ...
          >
            ...
            <small>
              ...
              {latestReveal.outcome.type !== 'bomb' && (
                <em>
                  {latestReveal.previousBalance.toLocaleString('en-US')} → {latestReveal.nextBalance.toLocaleString('en-US')}
                </em>
              )}
            </small>
          </div>
              ...
              return (
                <button
                  ...
                  className={[
                    ...
                    secondChancePending && wallet.state === 'hidden' ? 'big-spender__wallet--second-chance' : '',
                  ].join(' ')}
                  style={style}
                ...
                >
                  ...
                  {resultLabel && <strong className="big-spender__wallet-result">{resultLabel}</strong>}
