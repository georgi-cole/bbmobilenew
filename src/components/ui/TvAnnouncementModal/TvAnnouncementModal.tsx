...
const PHASE_COPY: Record<string, PhaseCopy> = {
  ...
  democracia: {
    ...
    label: 'DEMOCRACIA',
    category: 'Shock',
    body: 'The usual Leader of the House competition has been replaced. Every active houseguest now votes in secret to elect the new Leader of the House.',
    shockDetail: 'If the vote ends in a tie, the tied candidates face a ballotage and only the remaining houseguests may vote. If the ballotage is still tied, the public may break it by approval rating — or, with public mode off, both tied players become co-Leaders of the House.',
  },
  democracia_ballotage: {
    icon: '⚖️',
    label: 'BALLOTAGE',
    category: 'Ceremony',
    body: 'The Democracia vote has produced a tie, so the election moves to a dramatic ballotage.',
    shockDetail: 'Only houseguests who are not part of the tie may vote in the ballotage. The tied candidates must wait while the rest of the house decides the result in secret.',
  },
  democracia_public_breaker: {
    icon: '📊',
    label: 'PUBLIC TIE-BREAK',
    category: 'Ceremony',
    body: 'The ballotage is still tied, so the public approval meter becomes the final decider.',
    shockDetail: 'The tied candidates are ranked by public approval. The higher-rated player is crowned Leader of the House, turning the audience into the final arbiter of power.',
  },
  democracia_results: {
    icon: '👑',
    label: 'DEMOCRACIA RESULT',
    category: 'Ceremony',
    body: 'The votes have been revealed and a new Leader of the House has been crowned.',
    shockDetail: 'Democracia can produce a single elected Leader of the House, a public tie-break winner, or even co-Leaders when the deadlock cannot be broken internally.',
  },
  democracia_co_loh: {
    icon: '👑',
    label: 'CO-LEADERS',
    category: 'Ceremony',
    body: 'The ballotage remained tied, forcing an extraordinary outcome: two players now share the power as co-Leaders of the House.',
    shockDetail: 'Each co-Leader names one nominee, creating a split-power week where alliances and blame can move in different directions at once.',
  },
