...
hoh_safety_request: {
    'give them a real opening': says('they can offer you a week of safety if you keep their name off the block.'),
    'ask what they are offering': says('their offer is one protected week and a vote you can call on.'),
    'set a clear limit': says('they understand there is no promise and will campaign elsewhere too.'),
    'end the pitch': acts('leaves without safety and starts looking for another route.'),
    'promise consideration': says('they will wait for your decision and avoid pushing you publicly.'),
...
nominee_hoh_plea: {
    ...
    'ask for their case': says('keeping them off the block leaves you one more vote you can still influence.'),
    'explain the risk': says('they understand your concern, but argue they are less dangerous than the alternative.'),
...
nominee_veto_pitch: {
    ...
    'refuse to commit': says('they know the power is still live and will keep pushing until the ceremony.'),
    'end the conversation': acts('leaves without a Safety promise and starts working the holder elsewhere.'),
    'promise the power': says('they treat the promise as real and stop looking for another saver.'),
    'hear their plan': says('their plan is to protect you next round if you pull them off the block.'),
    'keep your move private': says('they cannot tell whether they are being saved and remain on edge.'),
...
nominee_campaign: {
    ...
    'tell them where you stand': says('they appreciate the clarity and will work the undecided votes instead.'),
    'leave it there': acts('ends the pitch and moves on to the next voter.'),
    'ask what they need': says('they need one firm vote before they can pressure the fence-sitters.'),
...
nomination_aftershock: {
    'acknowledge the hurt': says('they needed someone to admit the nomination changed the relationship.'),
    ...
    'offer a path back': says('they are willing to rebuild if your next move shows it was strategic.'),
    'hear their anger': says('they feel exposed and believe someone close to them helped make it happen.'),
...
nominee_understands_loh: {
    'explain the decision': says('they accept the logic, but want proof the move was not personal.'),
    'hear them out': says('they can separate game from friendship only if your next move matches the explanation.'),
    'keep it strictly strategic': says('they will judge you only by what happens at Safety and the vote.'),
...
nominee_confronts_loh: {
    ...
    'explain the calculation': says('they understand the numbers, but still think you chose them too easily.'),
