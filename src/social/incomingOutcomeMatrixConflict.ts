...
betrayal_warning: {
    ...
    'take it seriously': says('they will keep watching quietly and tell you if the pattern repeats.'),
...
ignored_warning: {
    ...
    'ask what they need': says('they need you to initiate sometimes instead of making them chase every conversation.'),
    ...
    'acknowledge the distance': says('they mainly wanted confirmation that they were not imagining it.'),
    'keep it brief': says('they accept the short answer, but still read you as withdrawn.'),
    'say they are reading too much in': says('they disagree and point to how rarely you have checked in.'),
    'leave it there': acts('stops asking and lets your future actions answer instead.'),
  },
targeted_snark: {
    'ask what they mean': says('your name keeps appearing whenever people discuss who is overconnected.'),
    ...
    'push back directly': says('they now know you will answer the pressure instead of absorbing it.'),
...
alliance_reassurance: {
    ...
    'compare your plans': says('their priority is keeping the alliance off the block and aligned on one target.'),
    'admit your doubts': says('they want one concrete move this week to prove the alliance still works.'),
    ...
    'ask what changed': says('your recent distance made them unsure whether the pact still mattered.'),
