...
replacement_nominee_reacts_to_loh: {
    'explain the backup plan': says('they understand why a replacement was needed, but not why it had to be them.'),
    'hear their reaction': says('they feel blindsided because they were safe until the last decision.'),
    'stand by the choice': says('they accept that you are not reconsidering and start campaigning against the move.'),
    'end the talk': acts('leaves angry and starts working the vote without you.'),
    'acknowledge the blow': says('they wanted recognition that the replacement hit harder than an initial nomination.'),
    'keep it factual': says('they hear the mechanics, but say the trust damage is still real.'),
    'refuse to justify it': says('they stop asking and assume they were always your backup target.'),
...
post_veto_gratitude: {
    ...
    'say it was nothing': says('they do not buy that it was nothing and still count it as a favor.'),
...
post_veto_campaign: {
    'hear their new plan': says('they are rebuilding around the voters least committed to the new block.'),
...
live_vote_pitch: {
    ...
    'commit to keep them': says('they believe the vote is real and will remember it if they survive.'),
    'keep your options open': says('they need an answer before the vote and will not wait much longer.'),
...
survivor_gratitude: {
    ...
    'strengthen the bond': says('they want to turn surviving together into a real working relationship.'),
