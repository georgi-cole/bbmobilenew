...
const REGISTRY: Record<string, GameRegistryEntry> = {
  ...
  bigSpender: {
    ...
    instructions: [
      'Every player starts with 1,000 Eyeoleans and plays live on their own private 28-wallet board.',
      'Most wallets subtract Eyeoleans, some add Eyeoleans, and a few hide bombs.',
      'Open as many wallets as you dare, then lock in whenever your balance feels good.',
      'Reach 0 to make the strongest possible finish. The closer to 0 you are, the better you rank.',
      'If you open a bomb, the blast reveals first, then you may use up to two ad saves for a mandatory Second Chance Wallet.',
      'Final scores stay hidden during the run and reveal only on the results screen.',
