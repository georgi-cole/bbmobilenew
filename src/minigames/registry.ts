...
const REGISTRY: Record<string, GameRegistryEntry> = {
  ...
  quickTap: {
    ...
    instructions: [
      'A 3-second countdown starts immediately',
      'Tap the button as fast as possible for 30 seconds',
      'Watch for power-ups (⚡ 2× Frenzy, 🔥 3× Turbo) — they double or triple your taps!',
      'Beware the 🥴 Fumble debuff — it cuts each tap to half value',
  ...
  memoryMatch: {
    key: 'memoryMatch',
    title: 'Memory Colors',
    description: 'Watch and repeat a growing color sequence — one mistake allowed!',
    instructions: [
      '4 colored pads light up one at a time',
      'Memorize the sequence, then tap the pads in the same order',
      'Each round adds one more color to the sequence',
      'You get exactly 1 mistake total — the second mistake ends your run',
  ...
  logicLocks: {
    key: 'logicLocks',
    title: 'Vault Cracker',
    description: 'Race the clock to crack the 4-digit vault combination',
    instructions: [
      'Use the ▲ / ▼ controls to set each digit of your guess',
      'Tap "Try Combination" to submit',
      '🟢 Green pip = right digit, right position',
      '🟡 Gold pip = right digit, wrong position',
      'Crack the code faster for a higher score!',
    ],
    metricKind: 'accuracy',
    metricLabel: 'Score',
    timeLimitMs: 60_000,
  ...
  castleRescue: {
    key: 'castleRescue',
    title: 'Castle Rescue',
    description: 'Swap crests to crack a flooded dungeon apart, clear the finite board, and save the king before the water rises too high!',
    instructions: [
      'Swap adjacent crests to create matches of 3 or more identical symbols.',
      'Each match clears those gems, makes the remaining pieces fall, and can trigger cascades.',
      'Crates and stone slabs must be chipped away by matching next to them; reinforced slabs need 2 hits.',
      'The board is finite — there is no endless refill. Clear every gem and blocker to break the floodgate.',
      'The water rises for 2 minutes. Save the king before it reaches the cell, and chase score with combos and fast clears.',
      'If the board jams, use the reshuffle button — it preserves a solvable path to full clear.',
    ],
    metricKind: 'points',
    metricLabel: 'Score',
    timeLimitMs: 120_000,
