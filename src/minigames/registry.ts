...
const REGISTRY: Record<string, GameRegistryEntry> = {
  ...
  bigSpender: {
    ...
    instructions: [
      'Every player starts with 1,200 Eyeoleans and plays live on their own private 32-wallet board.',
      ...
      'If you open a bomb, the blast reveals first, then you may use up to two ad saves and personally pick a mandatory Second Chance Wallet.',
