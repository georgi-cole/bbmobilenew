...
describe('PublicMeter tabs', () => {
  it('shows overview content by default', () => {
    ...
    expect(screen.getByRole('tab', { name: 'Public Meter' })).toHaveAttribute('aria-selected', 'true');
  ...
  it('opens requests tab from the query param', () => {
    ...
    expect(screen.getByRole('tab', { name: /Public Requests/i })).toHaveAttribute('aria-selected', 'true');
