...
import { CINEMATIC_CONFIG, CINEMATIC_CREDITS, type CreditCard } from '../../cinematic/config/cinematicConfig';
import { getCinematicQuality } from '../../cinematic/config/cinematicQuality';
import {
  loadCreditsContent,
...
export default function Credits() {
  ...
  const [renderScale] = useState(() => getCinematicQuality(true) === 'high' ? 1 : 0.5);
  ...
  const handleStart = useCallback((event: SyntheticEvent) => {
          ...
          {renderFailed ? (
            ...
            <CreditsRenderBoundary onFailure={handleRenderFailure}>
              <Player
                ...
                compositionWidth={CINEMATIC_CONFIG.width * renderScale}
                compositionHeight={CINEMATIC_CONFIG.height * renderScale}
