...
export default function GameScreen() {
  ...
  // storeRef is synced via useEffect; exclude it from deps to keep this callback stable.
      ...
      {showMinigameHost && pendingChallenge && (
        <MinigameHost
          ...
          onDone={(rawValue) => {
            ...
            // ── dontGoOver / holdWall / famousFigures / biographyBlitz: skip SpotlightAnimation ──
            let skipSpotlightAnimation = false;
            const gameKey = pendingChallenge.game.key;
            if (gameKey === 'dontGoOver' || gameKey === 'holdWall' || gameKey === 'famousFigures' || gameKey === 'biographyBlitz') {
