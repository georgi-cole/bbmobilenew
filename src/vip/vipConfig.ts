...
export const STORE_PRODUCT_CATALOG: readonly StoreProductDefinition[] = [
  ...
  },
  {
    ...
    shortTagline: 'Stay in the house. Outlast every replacement.',
    fullDescription:
      'Play the implemented endless Survival format, where evicted housemates are replaced and your run continues until you are eliminated.',
    benefits: [
      'Launch a dedicated Survival season',
      'Face an evolving replacement cast',
      'Track your best survival run',
      'Resume an unfinished Survival game',
    ],
    icon: 'survivalMode',
    ...
    category: 'game-mode',
    badge: 'Game mode',
    accessInstructions: 'Choose Survival from the Home screen.',
    accessRoute: '/',
  ...
  },
  {
    ...
    fullDescription:
      'Enable the implemented public-opinion controls that bring audience requests and public nominee decisions into eligible seasons.',
    benefits: [
      'Enable Public Mode in Settings',
      'Receive audience-driven requests',
      'Use public nominee decision rules',
  ...
  },
  {
    ...
    shortTagline: 'A different jury-house rule set.',
    fullDescription:
      'Reserve permanent access to the Tribunal House option exposed in the game settings.',
    benefits: [
    ...
    category: 'house-feature',
    badge: 'House feature',
    accessInstructions: 'Manage Tribunal House from Settings when the feature is available.',
    accessRoute: '/settings',
    accessLabel: 'Open Settings',
    legalNote:
  ...
  },
  {
    ...
    shortTagline: 'Turn every alliance into a storyline.',
    fullDescription:
      'Enable the advanced social simulation with more strategic alliances, grudges, betrayals, pleas, and contextual reactions.',
    benefits: [
      'Richer alliance decisions',
      'Context-aware social reactions',
      'Strategic grudges and betrayals',
      'More event-driven house drama',
    ],
    icon: 'dramaMode',
    visualTheme: 'drama',
    ownershipType: 'one-time',
    category: 'house-feature',
    badge: 'Social expansion',
    accessInstructions: 'Turn Drama Mode on or off in Settings.',
    accessRoute: '/settings',
    accessLabel: 'Open Settings',
  },
  {
    ...
    entitlement: 'noAds',
    shortTagline: 'Keep the house moving without interruptions.',
    fullDescription:
