(() => {
  ...
  button.onclick = () => {
    ...
    parent.postMessage({ type: 'twin:complete', score: Number.parseInt(text, 10) || 0 }, location.origin)
  }
  document.title = sequel ? 'Find Your Twin 2 — Remastered' : 'Find Your Twin — Remastered'
  document.querySelector('#intro .eyebrow').textContent = sequel ? 'FIND YOUR TWIN 2' : 'FIND YOUR TWIN'
